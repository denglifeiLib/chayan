        ...
        <el-form :model="form" :label-width="formLabelWidth">
            ...
            <el-form-item label="策略类型">
                <el-radio-group v-model="form.module" size="medium">
                    <el-radio border label="调研模式"><img :src="require('@/assets/images/type_1.png')" alt="" class="model_icon">调研模式</el-radio>
                    <el-radio border label="营销模式"><img :src="require('@/assets/images/type_2.png')" alt="" class="model_icon">营销模式</el-radio>
                </el-radio-group>
            ...
            <el-form-item label="策略类型">
                <div class="in_b">
                    <el-radio-group v-model="form.type" size="medium">
                        <el-radio border label="自动部署"></el-radio>
                        <el-radio border label="时段部署"></el-radio>
                    </el-radio-group>
                </div>
                <div class="in_b date">
            ...
            <el-form-item label-width='0'>
                ...
                <el-col :span="2">
                    <el-upload
                        ...
                        :auto-upload="false">
                        <el-button slot="trigger" size="small" plain icon="el-icon-upload">选取文件</el-button>
                    </el-upload>
                </el-col>
            </el-form-item>
            <el-form-item label-width='0'>
